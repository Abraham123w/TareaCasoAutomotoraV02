...
public class PantallaBusquedaVehiculo extends Ventana {
    ...
    public PantallaBusquedaVehiculo (Automotora automotora) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.botonRegresar) {
            // Si el evento es causado por el botón de regresar, se crea una instancia de la clase "VentanaMenuBienvenida"
            // y se cierra la ventana actual.
            MenuInicio ventanaMenuBienvenida = new MenuInicio(automotora);
            this.dispose();
        }
    }
